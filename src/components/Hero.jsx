...
const Hero = ({ onExploreClick, lang }) => {
  ...
  return (
    <section className="relative bg-[#FFFDF8] pt-6 sm:pt-10 md:pt-16 pb-14 md:pb-24 overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-5 sm:space-y-6 text-left z-10">
            ...
            {/* Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-[#F6F1E7] border border-[#E8E2D6] text-[11px] sm:text-xs font-sans-body font-semibold text-[#1D4F2B]">
            ...
            <h1 className="font-serif-heading text-3xl sm:text-4xl md:text-5xl lg:text-[50px] font-bold text-[#202020] leading-[1.18] sm:leading-[1.12] tracking-tight">
            ...
            <div className="bg-[#F6F1E7] p-3.5 rounded-2xl border border-[#E8E2D6] flex items-center gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-1">
              <button
                ...
                className="font-button text-xs sm:text-sm bg-[#1D4F2B] hover:bg-[#12351D] text-white px-6 sm:px-7 py-3.5 rounded-full flex items-center gap-2 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 group"
              >
              ...
              <a
                ...
                className="font-button text-xs sm:text-sm bg-transparent hover:bg-[#F6F1E7] text-[#202020] border border-[#E8E2D6] px-5 sm:px-6 py-3.5 rounded-full flex items-center gap-2 transition-all duration-300 hover:border-[#1D4F2B]"
              >
            ...
            {/* Trust Badges */}
            <div className="pt-3 flex flex-wrap items-center gap-4 sm:gap-6 text-xs text-[#666666] font-medium border-t border-[#E8E2D6]/60">
          ...
          {/* Hero Image Column (55% -> 7 cols on lg) */}
          <div className="lg:col-span-7 relative">
            <div className="relative rounded-[20px] sm:rounded-[28px] overflow-hidden shadow-premium-soft border border-[#E8E2D6]/70 group">
              <img
                src={heroImg}
                alt="Freshly ground spices, turmeric, flour, and grains on rustic wooden table"
                className="w-full h-[320px] sm:h-[440px] lg:h-[520px] object-cover object-center transform group-hover:scale-102 transition-transform duration-700 ease-out"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent pointer-events-none" />

              {/* Floating Real Mill Sample Badge overlay on bottom-right */}
              <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 max-w-[260px] sm:max-w-[280px] bg-white/95 backdrop-blur-md p-3 rounded-2xl shadow-2xl border border-[#D8A43A] flex items-center gap-3">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl overflow-hidden shrink-0 border border-[#E8E2D6]">
                  <img
                    src={realMillImg}
                    alt="PKS Straightway Mill Storefront Sample"
                    className="w-full h-full object-cover filter contrast-110 brightness-105"
                  />
                </div>
                <div className="text-left">
                  <div className="text-[9px] sm:text-[10px] font-button bg-[#D8A43A]/20 text-[#12351D] font-bold px-2 py-0.5 rounded-full inline-block uppercase">
                    Sample Mill Photo
                  </div>
                  <div className="font-serif-heading text-xs font-bold text-[#12351D] mt-0.5 leading-snug">
      ...
      {/* Wave Divider */}
      <div className="w-full overflow-hidden leading-none mt-8 sm:mt-12 md:mt-16">
        <svg
