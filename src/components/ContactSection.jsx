    ...
    <section id="contact" className="bg-[#FFFDF8] py-6 sm:py-20 md:py-28 relative">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-5 md:px-8 space-y-8 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          {/* Contact Details & Google Maps Card */}
          <div className="lg:col-span-5 bg-[#F6F1E7] rounded-2xl sm:rounded-[24px] p-4 sm:p-6 sm:p-8 border border-[#E8E2D6] space-y-4 sm:space-y-6 text-left shadow-sm">
            ...
            <a 
              href={t?.mapsUrl || "https://maps.app.goo.gl/ddsHNEFHqwWLMnDS6"} 
              target="_blank" 
              rel="noopener noreferrer" 
              className="w-full font-button text-xs bg-white border border-[#D8A43A] hover:bg-[#D8A43A] hover:text-white text-[#12351D] py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all font-semibold shadow-sm"
            >
              <Star className="w-4 h-4 fill-[#D8A43A] text-[#D8A43A]" />
              <span>{t?.contact?.reviewsBtn || "Read Our Google Reviews"}</span>
              <ExternalLink className="w-3.5 h-3.5" />
            </a>

            <div className="space-y-4 text-sm text-[#202020] pt-2 border-t border-[#E8E2D6]">
              {/* Phone */}
              <a href="tel:+918714348348" className="flex items-start gap-4 p-3.5 rounded-xl bg-white border border-[#E8E2D6] hover:border-[#1D4F2B] transition-colors group">
                ...
                <div>
                  <span className="block text-xs font-semibold text-[#666666] uppercase">Phone Numbers</span>
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/918714348348" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 p-3.5 rounded-xl bg-white border border-[#E8E2D6] hover:border-[#25D366] transition-colors group">
                ...
                <div>
                  <span className="block text-xs font-semibold text-[#666666] uppercase">Direct WhatsApp</span>
                  <span className="font-sans-body font-bold text-[#12351D] text-sm">{t?.phone1 || "+91 8714 348 348"}</span>
                </div>
              </a>
              ...
              <div className="flex items-start gap-4 p-3.5 rounded-xl bg-white border border-[#E8E2D6]">
                ...
                <div className="space-y-1">
                  <span className="block text-xs font-semibold text-[#666666] uppercase">Shop Location</span>
                  ...
                  <span className="text-[11px] font-mono text-[#D8A43A] font-semibold block">Plus Code: 77QM+6J Karulai, Kerala</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <a href={t?.mapsUrl || "https://maps.app.goo.gl/ddsHNEFHqwWLMnDS6"} target="_blank" rel="noopener noreferrer" className="w-full font-button text-xs bg-white hover:bg-[#1D4F2B] text-[#12351D] hover:text-white border border-[#E8E2D6] hover:border-[#1D4F2B] py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all font-semibold shadow-sm">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl sm:rounded-[24px] p-4 sm:p-6 sm:p-8 border border-[#E8E2D6] shadow-premium-soft text-left space-y-4 sm:space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-[#202020] uppercase tracking-wider mb-2">Your Name</label>
                <input type="text" name="name" required placeholder="Enter your name" className="w-full bg-[#FFFDF8] border border-[#E8E2D6] rounded-xl px-4 py-3 text-sm text-[#12351D] focus:outline-none focus:border-[#1D4F2B]" />
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-[#202020] uppercase tracking-wider mb-2">Phone Number</label>
                  <input type="tel" name="phone" required placeholder="+91 Mobile number" className="w-full bg-[#FFFDF8] border border-[#E8E2D6] rounded-xl px-4 py-3 text-sm text-[#12351D] focus:outline-none focus:border-[#1D4F2B]" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-[#202020] uppercase tracking-wider mb-2">Subject</label>
                  <input type="text" name="subject" placeholder="Product inquiry / Custom Milling" className="w-full bg-[#FFFDF8] border border-[#E8E2D6] rounded-xl px-4 py-3 text-sm text-[#12351D] focus:outline-none focus:border-[#1D4F2B]" />
                </div>
              </div>

              <div>
                <label className="block text-xs font-semibold text-[#202020] uppercase tracking-wider mb-2">Your Message</label>
                <textarea name="message" rows="4" required placeholder="How can we help you?" className="w-full bg-[#FFFDF8] border border-[#E8E2D6] rounded-xl px-4 py-3 text-sm text-[#12351D] focus:outline-none focus:border-[#1D4F2B]"></textarea>
              </div>

              <button type="submit" className="w-full font-button text-xs sm:text-sm bg-[#1D4F2B] hover:bg-[#12351D] text-white py-3.5 px-6 rounded-xl flex items-center justify-center gap-2 shadow-md transition-colors">
